...
class MQTT:
    ...
    sub_topics = [("620157646_pub", 0), ("620157646", 0), ("620157646_sub", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620157646", self.gdp)
        self.client.message_callback_add("620157646_sub", self.toggle)
